...
int main() {
	...
	KNN_ACCELERATOR_mWriteReg(XPAR_KNN_ACCELERATOR_0_S00_AXI_BASEADDR, KNN_ACCELERATOR_S00_AXI_SLV_REG1_OFFSET, ((NUM_POINTS-1)/2)+1);
	...
	//while(KNN_DMA_mReadReg(XPAR_KNN_DMA_0_S_AXI_LITE_BASEADDR, KNN_DMA_S_AXI_LITE_SLV_REG1_OFFSET) != 5) {}
