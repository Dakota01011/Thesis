...
int main() {
	...
	while(XAxiDma_ReadReg(XPAR_AXI_DMA_0_BASEADDR, XAXIDMA_TX_OFFSET + XAXIDMA_SR_OFFSET) != 4098) {} //TODO: check that 4098 is correct value	
	while(XAxiDma_ReadReg(XPAR_AXI_DMA_1_BASEADDR, XAXIDMA_TX_OFFSET + XAXIDMA_SR_OFFSET) != 4098) {} //TODO: check that 4098 is correct value
