proc create_ipi_design { offsetfile design_name } {
	...
	set My_PWM_Core_0 [ create_bd_cell -type ip -vlnv cirrus.com:user:My_PWM_Core:1.0 My_PWM_Core_0]
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores cirrus.com:user:My_PWM_Core:1.0]]]]
