proc create_ipi_design { offsetfile design_name } {
	...
	set KNN_accelerator_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:KNN_accelerator:2.0 KNN_accelerator_0]
	...
	set offset_file "${bd_path}/KNN_accelerator_v2_0_tb_include.vh"
	set fp [open $offset_file "w"]
	puts $fp "`ifndef KNN_accelerator_v2_0_tb_include_vh_"
	puts $fp "`define KNN_accelerator_v2_0_tb_include_vh_\n"
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores xilinx.com:user:KNN_accelerator:2.0]]]]
set test_bench_file ${ip_path}/example_designs/bfm_design/KNN_accelerator_v2_0_tb.v
...
for { set i 1 } { 1 } { incr i } {
	set design_name "KNN_accelerator_v2_0_bfm_${i}"
...
remove_files -quiet -fileset sim_1 KNN_accelerator_v2_0_tb_include.vh
import_files -fileset sim_1 -norecurse -force $interface_address_vh_file
set_property top KNN_accelerator_v2_0_tb [get_filesets sim_1]
