...
proc init_gui { IPINST } {
  ...
  set_property tooltip {Thread ID Width} ${C_M00_AXI_MM2S_ID_WIDTH}
  set C_M00_AXI_MM2S_ADDR_WIDTH [ipgui::add_param $IPINST -name "C_M00_AXI_MM2S_ADDR_WIDTH" -parent ${Page_0}]
  ...
  set_property tooltip {Thread ID Width} ${C_M01_AXI_MM2S_ID_WIDTH}
  set C_M01_AXI_MM2S_ADDR_WIDTH [ipgui::add_param $IPINST -name "C_M01_AXI_MM2S_ADDR_WIDTH" -parent ${Page_0}]
