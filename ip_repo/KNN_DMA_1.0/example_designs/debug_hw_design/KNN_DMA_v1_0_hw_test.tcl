# Runtime Tcl commands to interact with - KNN_DMA_v1_0

# Sourcing design address info tcl
set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
source ${bd_path}/KNN_DMA_v1_0_include.tcl
...
# Test: M00_AXI_MM2S
set wdata_m00_axi_mm2s [get_init_data 0]
create_hw_axi_txn w_m00_axi_mm2s_addr [get_hw_axis $jtag_axi_master] -type write -address $axi_gpio_out_addr -data ${wdata_m00_axi_mm2s}
create_hw_axi_txn r_m00_axi_mm2s_addr [get_hw_axis $jtag_axi_master] -type read -address $axi_gpio_in_addr 
# Initiate transactions
run_hw_axi r_m00_axi_mm2s_addr
run_hw_axi w_m00_axi_mm2s_addr
run_hw_axi r_m00_axi_mm2s_addr
set rdata_tmp [get_property DATA [get_hw_axi_txn r_m00_axi_mm2s_addr]]
set DE [ get_done_and_error_bit $rdata_tmp 2 0 ]
# Compare read data
if { $DE == 01 } {
	puts "Data comparison test pass for - M00_AXI_MM2S"
} else {
	puts "Data comparison test fail for - M00_AXI_MM2S, rdata-$rdata_tmp expected-01 actual-$DE"
	inc ec
}

# Test: M01_AXI_MM2S
set wdata_m01_axi_mm2s [get_init_data 1]
create_hw_axi_txn w_m01_axi_mm2s_addr [get_hw_axis $jtag_axi_master] -type write -address $axi_gpio_out_addr -data ${wdata_m01_axi_mm2s}
create_hw_axi_txn r_m01_axi_mm2s_addr [get_hw_axis $jtag_axi_master] -type read -address $axi_gpio_in_addr 
# Initiate transactions
run_hw_axi r_m01_axi_mm2s_addr
run_hw_axi w_m01_axi_mm2s_addr
run_hw_axi r_m01_axi_mm2s_addr
set rdata_tmp [get_property DATA [get_hw_axi_txn r_m01_axi_mm2s_addr]]
set DE [ get_done_and_error_bit $rdata_tmp 2 1 ]
# Compare read data
if { $DE == 01 } {
	puts "Data comparison test pass for - M01_AXI_MM2S"
} else {
	puts "Data comparison test fail for - M01_AXI_MM2S, rdata-$rdata_tmp expected-01 actual-$DE"
	inc ec
}
